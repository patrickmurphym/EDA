...
void BubbleSort(int A[], int asc, int N)
{
...
void InsertionSort(int A[], int asc, int N)
{
//si el compilador que usas no reconoce el tipo bool usa int
//escribe aquí tu función
...
void SelectionSort(int A[], int asc, int N)
{
//si el compilador que usas no reconoce el tipo bool usa int
//escribe aquí tu función
...
void CountingSort(int A[], int max, int asc, int N)
{
//si el compilador que usas no reconoce el tipo bool usa int
//escribe aquí tu función
